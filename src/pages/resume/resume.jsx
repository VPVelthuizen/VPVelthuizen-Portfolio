...
const Resume = () => {
    ...
    return (
        <>
            ...
            <section id="Experience" className="bodysection">
                <h2>EXPERIENCE</h2>
            ...
            <section id="Education" className="bodysection">
                <h2>EDUCATION</h2>
                <div className="content">
                    <div className="container1">
            ...
            <section id="References" className="bodysection">
                <h2>REFERENCES</h2>
                <div className="content">
                    <ul>
            ...
            <section id="Skills" className="bodysection">
                <h2>SKILLS</h2>
                <div className="content">
                    <ul>
            ...
            <section id="Awards" className="bodysection">
                <h2>AWARDS</h2>
                <div className="content">
                    <ul>
            ...
            <section id="Languages" className="bodysection">
                <h2>LANGUAGES</h2>
                <div className="content">
                    <p>English</p>
                </div>
